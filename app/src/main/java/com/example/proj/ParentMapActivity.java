...
//        mapFragment.getMapAsync(this);
        ...
        mLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ParentMapActivity.this, trackit_selectuser.class);
        ...
        mSettings.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ParentMapActivity.this, ParentSettingsActivity.class);
                startActivity(intent);
                return;
            }
        });
...
//        mMap.setMyLocationEnabled(true);
    ...
    *-------------------------------------------------------------------*/
                ...
                new android.app.AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ActivityCompat.requestPermissions(ParentMapActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);
                            }
                        })
                        .create()
                        .show();
    ...
    private void getDriversAround(){
        ...
        DatabaseReference loc = FirebaseDatabase.getInstance().getReference().child("Parent");
        ...
        mFirebaseDatabaseReference.child("Users").child(mFirebaseUser.getUid()).addValueEventListener(new ValueEventListener() {
            @Override
//			public void onDataChange(DataSnapshot dataSnapshot) {
//				Userr u = dataSnapshot.getValue(Userr.class);
//				mEmail = u.email;
//			}
            public void onDataChange(DataSnapshot dataSnapshot){
        ...
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                ...
                for(Marker markerIt : markers){
                    if(markerIt.getTag().equals(mEmail))
                        return;
                }

                LatLng driverLocation = new LatLng(location.latitude, location.longitude);

                Marker mDriverMarker = mMap.addMarker(new MarkerOptions().position(driverLocation).title(mEmail).icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_child)));
